...
int main() {
    ...
    string metterFileName = prefix + to_string(DateUtil::getTimeSinceEpochMillisec()) + extension;
   ...
   cout<<"Begin program";
    while(1) {
       ...
       if(jsonArray.size()> 20) {
        // tạo file mới mới. 
        metterFileName = prefix + to_string(DateUtil::getTimeSinceEpochMillisec()) + extension;
        count = 0;
        jsonArray.clear();
